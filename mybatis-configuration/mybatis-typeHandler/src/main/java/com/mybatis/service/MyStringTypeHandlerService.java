...
public class MyStringTypeHandlerService {
	
	
	Logger LOGGER = Logger.getLogger(MyStringTypeHandlerService.class);
	...
	public void testUserDao() {
		...
		try {
			sqlsession = SqlSessionFactoryUtils.getSqlSessionFactory(
					"sqlMapConfig-MyStringTypeHandler.xml").openSession();
			// 通过Mapper接口
